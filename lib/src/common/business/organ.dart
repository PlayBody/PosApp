...
class ClOrgan {
  Future<List<OrganModel>> loadStaffOrgans(
      context, String staffId) async {
    List<OrganModel> organs = [];
    Map<dynamic, dynamic> results = {};
    
    await Webservice().loadHttp(context, apiLoadOrgans, {
      'staff_id': staffId
    }).then((v) => {results = v});
  ...
  Future<OrganModel> loadOrganInfo(context, String organId) async {
    ...
    return OrganModel.fromJson(results['data']);
  }
  ...
  Future<List<OrganModel>> loadOrganHaveShiftMode(
      context, companyId, staffId) async {
    Map<dynamic, dynamic> results = {};

    await Webservice().loadHttp(context, apiLoadOrgansHavShiftMode, {
      'company_id': companyId,
      'staff_id': staffId
