...
import 'package:staff_pos_app/src/interface/pos/accounting/orderIndividual.dart';
...
class Funcs {
  ...
  String extractNumber(String input) {
    ...
    // Find the first match (number) in the string
    Match? match = regExp.firstMatch(input);
    // Return the number if found, otherwise an empty string
