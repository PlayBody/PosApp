...
import 'package:staff_pos_app/src/interface/admin/check_order/admin_check_order_frame.dart';
...
import '../../common/business/organ.dart';
import '../../model/organmodel.dart';
                ...
                children: [
                  Expanded(
                    child: SingleChildScrollView(
                      ...
                      children: [
                        if (globals.auth > 4) _getDropDownCompanies(),
                        ...
                        if (shiftOrgans.isNotEmpty)
                          AdminHomeMenuItem(
                            label: '出席確認',
                            tapFunc: () => Navigator.push(context,
                                MaterialPageRoute(builder: (_) {
                              return AdminCheckOrderFrame();
                            })),
                          ),
                        if (globals.auth > constAuthStaff)
                          AdminHomeMenuItem(
